...
# Edited from Amazon AWS default Dockerfile
# https://docs.docker.com/engine/reference/builder/#maintainer-deprecated
LABEL maintainer="philipjkim"

# Framework Versions
ENV VERSION_NODE_17=17
ENV VERSION_NODE_DEFAULT=$VERSION_NODE_17
ENV VERSION_RUBY_2_6=2.6.3
ENV VERSION_BUNDLER=2.0.1
ENV VERSION_RUBY_DEFAULT=$VERSION_RUBY_2_6
ENV VERSION_HUGO=0.75.1
ENV VERSION_YARN=1.22.17
ENV VERSION_AMPLIFY=7.6.9
